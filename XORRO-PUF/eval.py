...
# from submit import get_features, get_renamed_labels, solver
from submit1 import get_features, get_renamed_labels, solver
...
# train_res= np.zeros( ( len( timeouts ), 2 ) )
